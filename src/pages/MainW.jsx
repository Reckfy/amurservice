            ...
            <div className={activeTab === 'about' ? 'showmenu1' : 'showmenu2'}>
                ...
                <div className='docs' style={{ display: activeTab === 'docs' ? 'flex' : 'none' }}>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><a href=''>Лицензия на осуществление предпринимательской деятельности по управлению МКД по Ставропольскому краю</a></li>
                            <li><a href=''>Свидетельство о внесении в Единый реестр управления многоквартирными домами</a></li>
                            <li><a href=''>Свидетельство ИНН от 26.08.2024</a></li>
                            <li><a href=''>Свидетельство ОГРН от 26.08.2024</a></li>
                        </ul>
                    </div>
                </div>
            </div>
